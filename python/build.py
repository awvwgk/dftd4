...
"""
FFI builder module for dftd4 for usage from meson and from poetry.
...
For poetry we have to do the preprocessing ourselves here, this
requires us to use the C compiler to preprocess the header file
of dftd4 because the CFFI C parser cannot handle the certain C
